...
- Explicit creator consent and final placement approval
- Usage rights for all brand assets and modified content
- Visible sponsorship disclosure and campaign records
- Content suitability and brand-safety review
- Controls for sensitive categories, minors, politics, health, and regulated products
- Protection against deceptive edits or implied endorsements
- Clear takedown, dispute, and campaign-expiration processes
- Privacy-conscious audience measurement

SceneSponsor should never alter a person's words, actions, identity, or expressed opinion. The product changes eligible visual space around the content; it does not fabricate an endorsement.

## Initial Roadmap

### Phase 1 — Placement Studio

- Upload short-form video
- Detect candidate placement zones
- Insert a supplied 2D branded asset into a static scene
- Preview before and after versions
- Export creator-approved content

### Phase 2 — Campaign Marketplace

- Creator and brand profiles
- Campaign creation and matching
- Approval workflows and brand controls
- Placement pricing, reporting, and payouts

### Phase 3 — Intelligent Placement Network

- Motion-aware and 3D product integration
- Automated contextual matching
- Platform and agency APIs
- Large-scale measurement and optimization
